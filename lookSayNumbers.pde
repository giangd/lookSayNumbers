//seems like the max is aroung 32, need to test some more. it seems to change based on the characters
...
void encryptMessage(int numberOfTimes) {
...
void decryptMessage(int numberOfTimes) {
